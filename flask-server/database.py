...
def create_artwork_table():
    query_db("CREATE TABLE Artworks (Id INTEGER PRIMARY KEY AUTOINCREMENT,Title VARCHAR(255), Description TEXT,Image_path TEXT,Link TEXT,CategoryId INT)")
    query_db("INSERT INTO Artworks (Title,Description,Image_path,Link,CategoryId) values(?,?,?,?,?)",["Death Stranding","Nice game","images/deathStranding.jpg","https://en.wikipedia.org/wiki/Death_Stranding",1])
    query_db("INSERT INTO Artworks (Title,Description,Image_path,Link,CategoryId) values(?,?,?,?,?)",["Gladiator","Awesome fights","images/gladiator.jpg","https://en.wikipedia.org/wiki/Gladiator_(2000_film)",1])
